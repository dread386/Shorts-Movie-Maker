...
GRID_CELLS = {
    ...
    'AB': {'x': 0,    'y': 0,   'w': 960, 'h': 540, 'label': 'A+B (上段 左1/2)'},
    'BC': {'x': 480,  'y': 0,   'w': 960, 'h': 540, 'label': 'B+C (上段 中央1/2)'},
    'CD': {'x': 960,  'y': 0,   'w': 960, 'h': 540, 'label': 'C+D (上段 右1/2)'},
    'EF': {'x': 0,    'y': 540, 'w': 960, 'h': 540, 'label': 'E+F (下段 左1/2・手元)'},
    'FG': {'x': 480,  'y': 540, 'w': 960, 'h': 540, 'label': 'F+G (下段 中央1/2・ギター)'},
    'GH': {'x': 960,  'y': 540, 'w': 960, 'h': 540, 'label': 'G+H (下段 右1/2)'},

    # Horizontal 3-cell wide combos (1440 x 540)
    'ABC': {'x': 0,    'y': 0,   'w': 1440, 'h': 540, 'label': 'A+B+C (上段 左3/4)'},
    'BCD': {'x': 480,  'y': 0,   'w': 1440, 'h': 540, 'label': 'B+C+D (上段 右3/4・A以外)'},
    'EFG': {'x': 0,    'y': 540, 'w': 1440, 'h': 540, 'label': 'E+F+G (下段 左3/4)'},
    'FGH': {'x': 480,  'y': 540, 'w': 1440, 'h': 540, 'label': 'F+G+H (下段 右3/4・E以外)'},

    # Horizontal 4-cell full row combos (1920 x 540)
    'ABCD': {'x': 0,   'y': 0,   'w': 1920, 'h': 540, 'label': 'A+B+C+D (上段 全幅4/4)'},
    'EFGH': {'x': 0,   'y': 540, 'w': 1920, 'h': 540, 'label': 'E+F+G+H (下段 全幅4/4)'},

    # Vertical 2-cell tall combos (480 x 1080)
    'AE': {'x': 0,    'y': 0,   'w': 480, 'h': 1080, 'label': 'A+E (左端縦長 1/4)'},
    'BF': {'x': 480,  'y': 0,   'w': 480, 'h': 1080, 'label': 'B+F (中左縦長 1/4)'},
    'CG': {'x': 960,  'y': 0,   'w': 480, 'h': 1080, 'label': 'C+G (中右縦長 1/4)'},
    'DH': {'x': 1440, 'y': 0,   'w': 480, 'h': 1080, 'label': 'D+H (右端縦長 1/4)'},

    # 2x2 Blocks (960 x 1080)
    'ABEF': {'x': 0,   'y': 0,   'w': 960,  'h': 1080, 'label': '左半分全体 (AB+EF)'},
    'BCFG': {'x': 480, 'y': 0,   'w': 960,  'h': 1080, 'label': '中央半分 (BC+FG)'},
    'CDGH': {'x': 960, 'y': 0,   'w': 960,  'h': 1080, 'label': '右半分全体 (CD+GH)'},

    # Full / Center
    'FULL':   {'x': 0,   'y': 0, 'w': 1920, 'h': 1080, 'label': 'FULL (16:9全体フル)'},
